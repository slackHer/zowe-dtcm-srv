...
export declare class TextUtils {
     ...
     */
    static getTable(objects: any[], primaryHighlightColor: string, maxColumnWidth?: number, includeHeader?: boolean, includeBorders?: boolean, hardWrap?: boolean): string;
    /**
     ...
     * @returns {string}
     */
    static wordWrap(text: string, width?: number, indent?: string, hardWrap?: boolean): string;
    /**
