...
class ProfileIO {
     ...
     * @memberof ProfileIO
     */
    static createProfileDirs(path) {
        try {
            io_1.IO.createDirsSync(path);
        }
        catch (err) {
     ...
     * @memberof ProfileIO
     */
    static writeProfile(fullFilePath, profile) {
        try {
            /**
             ...
             */
            const writeProfile = writeYaml.stringify(profileCopy, ProfileIO.MAX_YAML_DEPTH);
            /**
     ...
     * @memberof ProfileIO
     */
    static deleteProfile(name, fullFilePath) {
        try {
            /**
            ...
            if (fs.existsSync(fullFilePath)) {
                const errorMsg = `The profile ${name} was unable to be deleted. ` +
             ...
             */
            if (deleteErr instanceof error_1.ImperativeError) {
                throw deleteErr;
            }
            else {
                throw new error_1.ImperativeError({
     ...
     * @memberof ProfileIO
     */
    static writeMetaFile(meta, path) {
        try {
            const yamlString = writeYaml.stringify(meta, ProfileIO.MAX_YAML_DEPTH);
     ...
     * @memberof ProfileIO
     */
    static readProfileFile(filePath, type) {
        let profile;
        try {
 ...
 * @memberof ProfileIO
 */
ProfileIO.ERROR_ID = "Profile IO Error";
exports.ProfileIO = ProfileIO;
//# sourceMappingURL=ProfileIO.js.map