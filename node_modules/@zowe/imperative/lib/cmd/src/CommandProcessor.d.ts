...
export declare class CommandProcessor {
     ...
     * @memberof CommandProcessor
     */
    readonly envVariablePrefix: string;
    /**
     ...
     * @memberof CommandProcessor
     */
    readonly helpGenerator: IHelpGenerator;
    /**
     ...
     * @memberof CommandProcessor
     */
    readonly profileFactory: IProfileManagerFactory<ICommandProfileTypeConfiguration>;
    /**
     ...
     * @return {ICommandDefinition}: The Bright Commands definition document.
     */
    readonly fullDefinition: ICommandDefinition;
    /**
