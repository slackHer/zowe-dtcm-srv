...
export declare abstract class AbstractHelpGeneratorFactory implements IHelpGeneratorFactory {
     ...
     * @memberof AbstractHelpGeneratorFactory
     */
    protected readonly primaryHighlightColor: string;
    /**
     ...
     * @memberof AbstractHelpGeneratorFactory
     */
    protected readonly produceMarkdown: boolean;
    /**
     ...
     * @memberof AbstractHelpGeneratorFactory
     */
    protected readonly factoryParameters: IHelpGeneratorFactoryParms;
}
