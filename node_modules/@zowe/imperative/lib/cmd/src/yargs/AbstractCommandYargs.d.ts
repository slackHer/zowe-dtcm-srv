...
export declare abstract class AbstractCommandYargs {
     ...
     * @memberof AbstractCommandYargs
     */
    protected readonly rootCommandName: string;
    /**
     ...
     * @memberof AbstractCommandYargs
     */
    protected readonly commandLine: string;
    /**
     ...
     * @memberof AbstractCommandYargs
     */
    protected readonly envVariablePrefix: string;
    protected readonly promptPhrase: string;
    /**
     * Accessor for the command response parms (for subclasses)
     * @return {ICommandResponseParms} - Command response object
     */
    protected readonly responseParms: ICommandResponseParms;
    /**
     ...
     * @memberof AbstractCommandYargs
     */
    protected readonly helpGeneratorFactory: IHelpGeneratorFactory;
    /**
     ...
     * @memberof AbstractCommandYargs
     */
    protected readonly profileManagerFactory: IProfileManagerFactory<any>;
    /**
     ...
     */
    readonly parents: GroupCommandYargs[];
    /**
