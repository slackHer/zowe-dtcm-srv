...
export declare class CommandResponse implements ICommandResponseApi {
    ...
    readonly format: IHandlerFormatOutputApi;
    /**
     ...
     * @memberof CommandResponse
     */
    readonly console: IHandlerResponseConsoleApi;
    /**
     ...
     * @memberof CommandResponse
     */
    readonly data: IHandlerResponseDataApi;
    /**
     ...
     * @memberof CommandResponse
     */
    readonly progress: IHandlerProgressApi;
    /**
     ...
     * @memberof CommandResponse
     */
    readonly responseFormat: COMMAND_RESPONSE_FORMAT;
    /**
