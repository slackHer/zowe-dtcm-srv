...
const cliCmdName = utilities_1.ImperativeConfig.instance.findPackageBinName() ?
    utilities_1.ImperativeConfig.instance.findPackageBinName() : "Your_CLI_Command_Name";
const pluginDescription = "A space-separated list of plug-ins to install. A plug-in can be " +
...
const registryDescription = "The npm registry that is used when installing remote packages. When this value is omitted, the " +
    "value returned by `npm config get registry` is used.\n" +
    "\n" +
    "For more information about npm registries, see: " +
    "https://docs.npmjs.com/misc/registry";
const fileDescription = "Specifies the location of a plugins.json file that contains the plug-ins you want to install.\n" +
    "\n" +
    "All plug-ins specified in plugins.json will be installed to the base CLI and " +
    `the contents will be placed into ${PMFConstants_1.PMFConstants.instance.PLUGIN_JSON}.\n` +
    "\n" +
    "If you do not specify a plugins.json file and do not specify a plug-in, the default " +
    `plugin.json file (${PMFConstants_1.PMFConstants.instance.PLUGIN_JSON}) will be used. This provides a ` +
    "way to install plug-ins that were lost or corrupted after " +
    `reinstalling or updating ${utilities_1.ImperativeConfig.instance.loadedConfig.productDisplayName}.`;
const loginDescription = "The flag to add a registry user account to install from secure registry. It saves credentials " +
...
exports.installDefinition = {
    ...
    examples: [
        {
            description: `Install plug-ins saved in ${PMFConstants_1.PMFConstants.instance.PLUGIN_JSON}`,
            options: ""
        },
        {
...
//# sourceMappingURL=install.definition.js.map