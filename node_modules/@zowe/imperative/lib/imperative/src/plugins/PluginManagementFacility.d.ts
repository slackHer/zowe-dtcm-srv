...
export declare class PluginManagementFacility {
     ...
     */
    static readonly instance: PluginManagementFacility;
    /**
     ...
     */
    readonly allPluginCfgProps: IPluginCfgProps[];
    /**
     ...
     */
    readonly pluginOverrides: IImperativeOverrides;
    /**
     ...
     * @type {string}
     */
    private pluginNmForUseInCallback;
    /**
     ...
     */
    requirePluginModuleCallback(relativePath: string): any;
    /**
