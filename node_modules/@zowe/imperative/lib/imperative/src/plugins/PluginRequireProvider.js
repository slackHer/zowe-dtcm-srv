...
class PluginRequireProvider {
    ...
    constructor(modules) {
        ...
        if (perf_timing_1.PerfTiming.isEnabled) {
            ...
            Module.prototype.require = perf_timing_1.PerfTiming.api.unwatch(Module.prototype.require);
            Module.prototype.require = perf_timing_1.PerfTiming.api.watch(Module.prototype.require, `${Module.prototype.require.name} injected from module loader`);
        }
        ...
        Module.prototype.require = perf_timing_1.PerfTiming.api.watch(function PluginModuleLoader(request) {
