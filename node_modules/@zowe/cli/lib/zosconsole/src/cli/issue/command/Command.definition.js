...
exports.IssueCommandDefinition = {
    name: "command",
    aliases: ["cmd"],
    ...
    description: `Issue a z/OS console command and print command responses (known as "solicited command responses").` +
        ...
        `When issuing a z/OS console command using ${Constants_1.Constants.DISPLAY_NAME}, collection of all solicited command responses ` +
        ...
        `from a given command. Therefore, the ${Constants_1.Constants.DISPLAY_NAME} console APIs return a "solicited response key" ` +
        `that can be used to "follow-up" and collect any additional solicited command responses.` +
        `\n\n` +
        `${Constants_1.Constants.DISPLAY_NAME} will issue "follow-up" API requests by default ` +
        `to collect any additional outstanding solicited command responses until a request returns no additional responses. ` +
        `At that time, ${Constants_1.Constants.DISPLAY_NAME} will attempt a final collection attempt. ` +
    ...
    options: [
        ...
        },
        {
            ...
            aliases: ["id", "i"],
            description: `Include additional details at the end of the ${Constants_1.Constants.DISPLAY_NAME} command response, ` +
        ...
        },
        {
            ...
            description: `Displays only the "command response key" returned from the z/OSMF console API. ` +
                ...
                `'${Constants_1.Constants.BINARY_NAME} zos-console collect sync-responses <key>'. ` +
        ...
        },
        {
            name: "return-first",
            aliases: ["rf", "r"],
            description: `Indicates that ${Constants_1.Constants.DISPLAY_NAME} should return immediately with the response ` +
                `message set returned in the first z/OSMF API request (even if no responses are present). ` +
                `Using this option may result in partial or no response, but quicker ${Constants_1.Constants.DISPLAY_NAME} ` +
        ...
        },
        {
            ...
            aliases: ["wtc", "w"],
            description: `Indicates that ${Constants_1.Constants.DISPLAY_NAME} wait at least the specified number of seconds ` +
