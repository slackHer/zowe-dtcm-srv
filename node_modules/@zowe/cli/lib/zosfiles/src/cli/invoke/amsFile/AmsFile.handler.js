...
const invoke_1 = require("../../../api/methods/invoke");
...
class AmsFileHandler extends ZosFilesBase_handler_1.ZosFilesBaseHandler {
    processWithSession(commandParameters, session) {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            response = yield invoke_1.Invoke.ams(session, commandParameters.arguments.controlStatementsFile);
            commandParameters.response.console.log(imperative_1.TextUtils.prettyJson(response.apiResponse));
            return response;
        });
    }
}
exports.default = AmsFileHandler;
//# sourceMappingURL=AmsFile.handler.js.map