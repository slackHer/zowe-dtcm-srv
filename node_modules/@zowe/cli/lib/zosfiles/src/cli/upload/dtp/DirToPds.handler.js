 ...
 * @export
 */
class DirToPdsHandler extends ZosFilesBase_handler_1.ZosFilesBaseHandler {
    processWithSession(commandParameters, session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield upload_1.Upload.dirToPds(session, commandParameters.arguments.inputdir, commandParameters.arguments.dataSetName, {
...
exports.default = DirToPdsHandler;
//# sourceMappingURL=DirToPds.handler.js.map