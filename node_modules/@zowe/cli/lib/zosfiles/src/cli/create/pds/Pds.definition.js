...
exports.PdsDefinition = {
    ...
    options: [
        Object.assign({}, Create_options_1.ZosFilesCreateExtraOptions.size, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.primary + create_1.CreateDefaults.DATA_SET.PARTITIONED.alcunit }),
        Create_options_1.ZosFilesCreateOptions.volser,
        Object.assign({}, Create_options_1.ZosFilesCreateOptions.secondary, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.secondary }),
        Object.assign({}, Create_options_1.ZosFilesCreateOptions.dirblk, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.dirblk }),
        Object.assign({}, Create_options_1.ZosFilesCreateOptions.recfm, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.recfm }),
        Object.assign({}, Create_options_1.ZosFilesCreateOptions.blksize, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.blksize }),
        Object.assign({}, Create_options_1.ZosFilesCreateOptions.lrecl, { defaultValue: create_1.CreateDefaults.DATA_SET.PARTITIONED.lrecl }),
