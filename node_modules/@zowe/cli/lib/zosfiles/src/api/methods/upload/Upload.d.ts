...
import { AbstractSession, ITaskWithStatus } from "@zowe/imperative";
...
export declare class Upload {
     ...
     */
    static bufferToUSSFile(session: AbstractSession, ussname: string, buffer: Buffer, binary?: boolean, localEncoding?: string): Promise<string>;
    /**
     * Upload content to USS file
     * @param {AbstractSession} session - z/OS connection info
     * @param {string} ussname          - Name of the USS file to write to
     ...
     * @returns {Promise<object>}
     */
    static streamToUSSFile(session: AbstractSession, ussname: string, uploadStream: Readable, binary?: boolean, localEncoding?: string, task?: ITaskWithStatus): Promise<void>;
    static fileToUSSFile(session: AbstractSession, inputFile: string, ussname: string, binary?: boolean, localEncoding?: string, task?: ITaskWithStatus): Promise<IZosFilesResponse>;
    /**
    ...
    private static uploadFileAndTagBasedOnAttributes;
    /**
     * Get Log
