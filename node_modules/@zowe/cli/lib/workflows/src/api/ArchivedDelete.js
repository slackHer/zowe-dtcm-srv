...
class ArchivedDeleteWorkflow {
     ...
     * @returns {string}
     */
    static archivedDeleteWorkflow(session, workflowKey, zOSMFVersion = WorkflowConstants_1.WorkflowConstants.ZOSMF_VERSION) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            resourcesQuery += `${WorkflowConstants_1.WorkflowConstants.ARCH_WORKFLOW_RESOURCE}/${workflowKey}`;
            return rest_1.ZosmfRestClient.deleteExpectString(session, resourcesQuery, null);
        });
    }
}
exports.ArchivedDeleteWorkflow = ArchivedDeleteWorkflow;
//# sourceMappingURL=ArchivedDelete.js.map