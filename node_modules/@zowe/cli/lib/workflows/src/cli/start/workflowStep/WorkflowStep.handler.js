 ...
 */
class WorkflowStepHandler extends ZosmfBaseHandler_1.ZosmfBaseHandler {
    /**
    ...
    processCmd(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (sourceType) {
                case "workflowKey":
                    try {
                        yield __1.StartWorkflow.startWorkflow(this.mSession, this.arguments.workflowKey, this.arguments.resolveConflict, this.arguments.stepName, this.arguments.performFollowingSteps);
                    }
                    catch (err) {
                ...
                case "workflowName":
                    try {
                        getWfKey = yield __1.ListWorkflows.getWfKey(this.mSession, this.arguments.workflowName, undefined);
                        if (getWfKey === null) {
                        ...
                        yield __1.StartWorkflow.startWorkflow(this.mSession, getWfKey, this.arguments.resolveConflict, this.arguments.stepName, this.arguments.performFollowingSteps);
                    }
                    catch (err) {
                        error = "Start workflow: " + err;
                        throw error;
