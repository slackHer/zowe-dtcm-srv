 ...
 */
class ListArchivedWorkflowsHandler extends ZosmfBaseHandler_1.ZosmfBaseHandler {
    /**
    ...
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const width = 42;
            try {
                response = yield ListArchivedWorkflows_1.ListArchivedWorkflows.listArchivedWorkflows(this.mSession);
            }
            catch (err) {
