...
const Definition_1 = require("../../../api/Definition");
...
class ListActiveWorkflowsHandler extends ZosmfBaseHandler_1.ZosmfBaseHandler {
    ...
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const width = 42;
            try {
                response = yield Definition_1.DefinitionWorkflow.getWorkflowDefinition(this.mSession, undefined, this.arguments.definitionFilePath, this.arguments.listSteps, this.arguments.listVariables);
            }
            catch (err) {
