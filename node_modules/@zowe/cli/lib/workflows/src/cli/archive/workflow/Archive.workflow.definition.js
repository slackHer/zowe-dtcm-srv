...
const Archive_options_1 = require("../Archive.options");
...
exports.Workflow = {
    ...
    type: "command",
    handler: path_1.join(__dirname, "../Archive.handler"),
    profile: {
        optional: ["zosmf"],
    },
    options: ([
        Archive_options_1.ArchiveOptions.workflowName,
        Archive_options_1.ArchiveOptions.workflowKey,
    ]),
...
//# sourceMappingURL=Archive.workflow.definition.js.map