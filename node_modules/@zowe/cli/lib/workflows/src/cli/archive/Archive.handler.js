...
const ArchiveWorkflow_1 = require("../../api/ArchiveWorkflow");
 ...
 */
class ArchiveHandler extends ZosmfBaseHandler_1.ZosmfBaseHandler {
    /**
    ...
    processCmd(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (sourceType) {
                case "workflowKey":
                    try {
                        resp = yield ArchiveWorkflow_1.ArchiveWorkflow.archiveWorfklowByKey(this.mSession, this.arguments.workflowKey, undefined);
                    }
                    catch (err) {
                    ...
                    break;
                case "workflowName":
                    getWfKey = yield __1.ListWorkflows.listWorkflows(this.mSession, undefined, this.arguments.workflowName);
                    ...
                    for (const element of getWfKey.workflows) {
                        try {
                            resp = yield ArchiveWorkflow_1.ArchiveWorkflow.archiveWorfklowByKey(this.mSession, element.workflowKey);
