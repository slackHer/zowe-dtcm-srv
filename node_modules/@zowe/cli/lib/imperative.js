...
const ZosTso_constants_1 = require("./zostso/src/cli/constants/ZosTso.constants");
const zosuss_1 = require("./zosuss");
const config = {
    ...
    profiles: [
        {
            ...
            schema: {
                ...
                properties: {
                    host: {
                        type: "string",
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_HOST,
                    },
                    port: {
                        type: "number",
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_PORT,
                    },
                    user: {
                        type: "string",
                        secure: true,
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_USER,
                    },
                    password: {
                        type: "string",
                        secure: true,
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_PASSWORD,
                    },
                    rejectUnauthorized: {
                        type: "boolean",
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_REJECT_UNAUTHORIZED,
                    },
                    basePath: {
                        type: "string",
                        optionDefinition: zosmf_1.ZosmfSession.ZOSMF_OPTION_BASE_PATH,
                    },
                },
                required: ["host"],
            },
        ...
        },
        {
            ...
            schema: {
                ...
                properties: {
                    account: {
                        type: "string",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_ACCOUNT,
                    },
                    characterSet: {
                        type: "string",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_CHAR_SET,
                    },
                    codePage: {
                        type: "string",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_CODE_PAGE,
                    },
                    columns: {
                        type: "number",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_COLUMNS,
                    },
                    logonProcedure: {
                        type: "string",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_LOGON_PROCEDURE,
                    },
                    regionSize: {
                        type: "number",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_REGION_SIZE,
                    },
                    rows: {
                        type: "number",
                        optionDefinition: ZosTso_constants_1.TSO_OPTION_ROWS,
                    },
                },
                required: ["account"],
            },
        ...
        },
        {
            ...
            schema: {
                ...
                properties: {
                    host: {
                        type: "string",
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_HOST,
                    },
                    port: {
                        type: "number",
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_PORT,
                    },
                    user: {
                        type: "string",
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_USER,
                    },
                    password: {
                        type: "string",
                        secure: true,
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_PASSWORD,
                    },
                    privateKey: {
                        type: "string",
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_PRIVATEKEY,
                    },
                    keyPassphrase: {
                        type: "string",
                        secure: true,
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_KEYPASSPHRASE,
                    },
                    handshakeTimeout: {
                        type: "number",
                        optionDefinition: zosuss_1.SshSession.SSH_OPTION_HANDSHAKETIMEOUT,
                    },
                },
                required: ["host", "user"],
            },
