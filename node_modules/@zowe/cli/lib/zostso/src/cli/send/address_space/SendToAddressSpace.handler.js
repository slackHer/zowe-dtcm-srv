...
class Handler extends ZosTsoBaseHandler_1.ZosTsoBaseHandler {
    ...
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield __1.SendTso.sendDataToTSOCollect(this.mSession, commandParameters.arguments.servletKey, commandParameters.arguments.data);
...
//# sourceMappingURL=SendToAddressSpace.handler.js.map