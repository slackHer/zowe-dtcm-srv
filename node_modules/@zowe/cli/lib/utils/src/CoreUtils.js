 ...
 */
function trimLineToTerminalWidth(str) {
...
exports.trimLineToTerminalWidth = trimLineToTerminalWidth;
/**
 ...
 */
function getErrorContext(content, lineIndex) {
    let retValue = "";
    if (lineIndex < 0) {
    ...
    retValue +=
        trimLineToTerminalWidth(`\n > ${imperative_1.TextUtils.chalk.red(padLeft((lineIndex + 1).toString(), maxLineIndexLength))} |  ${lines[lineIndex]}`);
...
function readStdin() {
    return new Promise((resolve, reject) => {
        ...
        const log = imperative_1.Logger.getAppLogger();
        stream.resume();
