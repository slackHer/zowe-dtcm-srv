...
const ListInstanceInfo_1 = require("../../../api/ListInstanceInfo");
 ...
 */
class InstanceInfoHandler extends ZosmfBaseHandler_1.ZosmfBaseHandler {
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const registry = yield index_1.ListRegistryInstances.listFilteredRegistry(this.mSession, index_1.ProvisioningConstants.ZOSMF_VERSION, null, commandParameters.arguments.name);
            ...
            if (util_1.isNullOrUndefined(instances)) {
                ...
                const response = yield ListInstanceInfo_1.ListInstanceInfo.listInstanceCommon(this.mSession, index_1.ProvisioningConstants.ZOSMF_VERSION, id);
    ...
    formatProvisionedInstanceSummaryOutput(instance, option) {
        ...
        option = util_1.isNullOrUndefined(option) ? "ACTIONS" : option.toUpperCase();
        // Prettify the output
        switch (option) {
            // extended general information with actions summarised
            case "EXTENDED":
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceExtended, false);
                break;
            // summary info with actions
            case "SUMMARY":
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceSummary, false);
                break;
            // summary info with variables
            case "VARS":
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceSummaryWithVars, false);
                break;
            // summary info with extended actions and variables
            case "FULL":
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceFull, false);
                break;
            // default - summary with actions, variables ignored
            case "ACTIONS":
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceSummaryWithActions, false);
                break;
            default:
                prettifiedInstance = imperative_1.TextUtils.explainObject(instance, index_1.explainProvisionedInstanceSummaryWithActions, false);
                break;
